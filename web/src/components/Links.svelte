<div class="my-6 text-base font-semibold tracking-widest text-gray-800 uppercase sm:my-4 dark:text-blue-300 sm:text-sm">
  <ul class="flex items-center space-x-10 sm:space-x-12 ">
    <li class="inline transition-colors duration-200 dark:hover:text-yellow-300 hover:text-yellow-700">
      ...
      >
        <svg
          ...
          /></svg
        >
        <span class="hidden ml-1 sm:block hover:underline">GitHub</span>
      </a>
    </li>
    <li class="inline transition-colors duration-200 dark:hover:text-yellow-300 hover:text-yellow-700">
      <a
      ...
      >
        <svg
          ...
          /></svg
        >
        <span class="hidden ml-1 sm:block hover:underline">LinkedIn</span>
      </a>
    </li>
    <li class="inline transition-colors duration-200 dark:hover:text-yellow-300 hover:text-yellow-700">
      <a
      ...
      >
        <svg
          ...
          /></svg
        >
        <span class="hidden ml-1 sm:block hover:underline">Email</span>
      </a>
    </li>
    <li class="inline transition-colors duration-200 dark:hover:text-yellow-300 hover:text-yellow-700">
      <a href="" class="flex flex-row items-center" rel="external noopener noreferrer" target="_blank">
        <svg
          ...
          /></svg
        >
        <span class="hidden ml-1 sm:block hover:underline">Curriculum Vitae</span>
      </a>
    </li>
  </ul>
</div>
